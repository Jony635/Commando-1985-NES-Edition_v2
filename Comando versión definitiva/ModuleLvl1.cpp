...
bool ModuleLvl1::Start()
{
	...
	if (App->helicopter->firstimelvl1 == false) 
	{
		...
		App->enemies->AddEnemy(ENEMY_TYPES::KNIFE, 147, -(2880 - 2664 - SCREEN_HEIGHT));
		App->enemies->AddEnemy(ENEMY_TYPES::WHITEGUARD, 147, -(2880 - 2664 - SCREEN_HEIGHT));
		App->enemies->AddEnemy(ENEMY_TYPES::KNIFE, 147, -(2880 - 2664 - SCREEN_HEIGHT));

		
		App->enemies->AddEnemy(ENEMY_TYPES::WHITEGUARD, 70, -(2880 - 2591 - SCREEN_HEIGHT));
		App->enemies->AddEnemy(ENEMY_TYPES::KNIFE, 70, -(2880 - 2591 - SCREEN_HEIGHT));
		App->enemies->AddEnemy(ENEMY_TYPES::WHITEGUARD, 70, -(2880 - 2591 - SCREEN_HEIGHT));

		
		App->enemies->AddEnemy(ENEMY_TYPES::WHITEGUARD, 136, -(2880 - 2490 - SCREEN_HEIGHT));
		App->enemies->AddEnemy(ENEMY_TYPES::KNIFE, 136, -(2880 - 2490 - SCREEN_HEIGHT));
		App->enemies->AddEnemy(ENEMY_TYPES::KNIFE, 136, -(2880 - 2490 - SCREEN_HEIGHT));

		
		App->enemies->AddEnemy(ENEMY_TYPES::WHITEGUARD, 142, -(2880 - 2344 - SCREEN_HEIGHT));
		App->enemies->AddEnemy(ENEMY_TYPES::KNIFE, 142, -(2880 - 2344 - SCREEN_HEIGHT));
		App->enemies->AddEnemy(ENEMY_TYPES::WHITEGUARD, 142, -(2880 - 2344 - SCREEN_HEIGHT));
		App->enemies->AddEnemy(ENEMY_TYPES::KNIFE, 142, -(2880 - 2344 - SCREEN_HEIGHT));
		...
		App->enemies->AddEnemy(ENEMY_TYPES::WHITEGUARD, 94, -(2880 - 2214 - SCREEN_HEIGHT));
		App->enemies->AddEnemy(ENEMY_TYPES::KNIFE, 94, -(2880 - 2214 - SCREEN_HEIGHT));

		
		App->enemies->AddEnemy(ENEMY_TYPES::KNIFE, 114, -(2880 - 2103 - SCREEN_HEIGHT));
		App->enemies->AddEnemy(ENEMY_TYPES::KNIFE, 114, -(2880 - 2103 - SCREEN_HEIGHT));
		App->enemies->AddEnemy(ENEMY_TYPES::KNIFE, 114, -(2880 - 2103 - SCREEN_HEIGHT));

		
		App->enemies->AddEnemy(ENEMY_TYPES::KNIFE, 116, -(2880 - 1955 - SCREEN_HEIGHT));
		...
		App->enemies->AddEnemy(ENEMY_TYPES::KNIFE, 96, -(2880 - 1791 - SCREEN_HEIGHT));
		App->enemies->AddEnemy(ENEMY_TYPES::WHITEGUARD, 96, -(2880 - 1791 - SCREEN_HEIGHT));
		...
		App->enemies->AddEnemy(ENEMY_TYPES::KNIFE, 103, -(2880 - 1218 - SCREEN_HEIGHT));
		App->enemies->AddEnemy(ENEMY_TYPES::KNIFE, 103, -(2880 - 1218 - SCREEN_HEIGHT));
		App->enemies->AddEnemy(ENEMY_TYPES::KNIFE, 103, -(2880 - 1218 - SCREEN_HEIGHT));
		...
		App->enemies->AddEnemy(ENEMY_TYPES::KNIFE, 158, -(2880 - 785 - SCREEN_HEIGHT));
		...
		App->enemies->AddEnemy(ENEMY_TYPES::KNIFE, 143, -(2880 - 530 - SCREEN_HEIGHT));
		App->enemies->AddEnemy(ENEMY_TYPES::KNIFE, 143, -(2880 - 530 - SCREEN_HEIGHT));
		App->enemies->AddEnemy(ENEMY_TYPES::WHITEGUARD, 143, -(2880 - 530 - SCREEN_HEIGHT));
	

		App->enemies->AddEnemy(ENEMY_TYPES::WHITEGUARD, 136, -(2880 - 406 - SCREEN_HEIGHT));
		App->enemies->AddEnemy(ENEMY_TYPES::KNIFE, 136, -(2880 - 406 - SCREEN_HEIGHT));
		App->enemies->AddEnemy(ENEMY_TYPES::WHITEGUARD, 136, -(2880 - 406 - SCREEN_HEIGHT));
		App->enemies->AddEnemy(ENEMY_TYPES::KNIFE, 136, -(2880 - 406 - SCREEN_HEIGHT));
	

		App->enemies->AddEnemy(ENEMY_TYPES::KNIFE, 123, -(2880 - 120 - SCREEN_HEIGHT));
