...
bool ModuleLvl2::Start() {
	...
	App->enemies->AddEnemy(ENEMY_TYPES::PATHWHITEGUARD, 189, -(2880 - 2714 - SCREEN_HEIGHT), "path1");
	App->enemies->AddEnemy(ENEMY_TYPES::PATHWHITEGUARD, 118, -(2880 - 2698 - SCREEN_HEIGHT), "path1");
	App->enemies->AddEnemy(ENEMY_TYPES::PATHWHITEGUARD, 120, -(2880 - 2529 - SCREEN_HEIGHT), "path1");
	App->enemies->AddEnemy(ENEMY_TYPES::PATHWHITEGUARD, 216, -(2880 - 2498 - SCREEN_HEIGHT), "path1");
	App->enemies->AddEnemy(ENEMY_TYPES::PATHWHITEGUARD, 35, -(2880 - 2494 - SCREEN_HEIGHT), "path1");
	App->enemies->AddEnemy(ENEMY_TYPES::PATHWHITEGUARD, 85, -(2880 - 2131 - SCREEN_HEIGHT), "path1");
	App->enemies->AddEnemy(ENEMY_TYPES::PATHWHITEGUARD, 209, -(2880 - 2059 - SCREEN_HEIGHT), "path1");
	App->enemies->AddEnemy(ENEMY_TYPES::PATHWHITEGUARD, 41, -(2880 - 1932 - SCREEN_HEIGHT), "path1");
